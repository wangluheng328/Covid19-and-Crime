...
covid_new_c.coalesce(1).write.option("header","true").csv("stage2/new_confirmed.csv").save("new_confirmed.csv")
covid_new_d.coalesce(1).write.option("header","true").csv("stage2/new_deceased.csv").save("new_deceased.csv")
covid_new_r.coalesce(1).write.option("header","true").csv("stage2/new_recovered.csv").save("new_recovered.csv")
covid_new_tc.coalesce(1).write.option("header","true").csv("stage2/total_confirmed.csv").save("total_confirmed.csv")
covid_new_td.coalesce(1).write.option("header","true").csv("stage2/total_deceased.csv").save("total_deceased.csv")
...
covid_new_c.coalesce(1).write.option("header","true").csv("stage2/month_new_confirmed.csv").save("month_new_confirmed.csv")
covid_new_d.coalesce(1).write.option("header","true").csv("stage2/month_new_deceased.csv").save("month_new_deceased.csv")
covid_new_r.coalesce(1).write.option("header","true").csv("stage2/month_new_recovered.csv").save("month_new_recovered.csv")
covid_new_tc.coalesce(1).write.option("header","true").csv("stage2/month_total_confirmed.csv").save("month_total_confirmed.csv")
covid_new_td.coalesce(1).write.option("header","true").csv("stage2/month_total_deceased.csv").save("month_total_deceased.csv")