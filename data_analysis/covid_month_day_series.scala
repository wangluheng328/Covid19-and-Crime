...
covid_new_c.write.csv("stage2/new_confirmed.csv")
covid_new_d.write.csv("stage2/new_deceased.csv")
covid_new_r.write.csv("stage2/new_recovered.csv")
covid_new_tc.write.csv("stage2/total_confirmed.csv")
covid_new_td.write.csv("stage2/total_deceased.csv")
...
covid_new_c.write.csv("stage2/month_new_confirmed.csv")
covid_new_d.write.csv("stage2/month_new_deceased.csv")
covid_new_r.write.csv("stage2/month_new_recovered.csv")
covid_new_tc.write.csv("stage2/month_total_confirmed.csv")
covid_new_td.write.csv("stage2/month_total_deceased.csv")